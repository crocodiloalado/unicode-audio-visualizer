...
No build process. Open `index.html` directly in any modern browser (Chrome, Firefox, Safari with Web Audio API support).

## Architecture

This is a **single self-contained HTML file** with zero external dependencies. All logic lives inline in `index.html`.
